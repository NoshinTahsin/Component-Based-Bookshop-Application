...
Requires Interface: The check_inventory() method from the ClassLibraryInventory component, acts as a Requires interface for the ClassLibraryShopManager component. Whenever a order needs to be confirmed, this method is required and invoked to check if the ordered item exists in the inventory.
...
Provides Interface: The ClassLibraryShopManager component provides interface for the Bookshop project to perform confirm_order(), update_cart() and send_order().
